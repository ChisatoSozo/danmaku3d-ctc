...
export const choiceSound = new MultiSound('/engine-assets/sfx/select00.wav', 0.2);
export const selectSound = new MultiSound('/engine-assets/sfx/ok00.wav', 0.2);
export const backSound = new MultiSound('/engine-assets/sfx/cancel00.wav', 0.2);
...
export const enemyShoot = new MultiSound('/engine-assets/sfx/tan00.wav', 0.35, 1, 10);
