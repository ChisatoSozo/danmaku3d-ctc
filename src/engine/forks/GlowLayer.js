...
var GlowLayer = /** @class */ (function (_super) {
    ...
    GlowLayer.prototype._createTextureAndPostProcesses = function () {
        ...
        blurTextureWidth = this._engine.needPOTTextures
            ? Engine.GetExponentOfTwo(blurTextureWidth, this._maxSize)
            : blurTextureWidth;
        blurTextureHeight = this._engine.needPOTTextures
            ? Engine.GetExponentOfTwo(blurTextureHeight, this._maxSize)
            : blurTextureHeight;
        var textureType = 0;
        ...
        this._mainTexture.onAfterUnbindObservable.add(function () {
            ...
            if (internalTexture) {
                ...
                _this._engine.unBindFramebuffer(
                    internalTexture2 !== null && internalTexture2 !== void 0 ? internalTexture2 : internalTexture,
                    true,
                );
            }
        });
    ...
    GlowLayer.prototype.hasMesh = function (mesh) {
        ...
        if (this._includedOnlyMeshes.length || this._meshesUsingTheirOwnMaterials.length) {
            return (
                this._includedOnlyMeshes.indexOf(mesh.uniqueId) !== -1 ||
                this._meshesUsingTheirOwnMaterials.indexOf(mesh.uniqueId) !== -1
            );
        }
        // Excluded Mesh
    ...
    GlowLayer.Parse = function (parsedGlowLayer, scene, rootUrl) {
        var gl = SerializationHelper.Parse(
            function () {
